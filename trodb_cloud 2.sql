/*
 ...
 Source Server         : prod-aliyun-forcecop
 Source Server Type    : MySQL
 Source Server Version : 50732
 Source Host           : shulie-prod.mysql.rds.aliyuncs.com:3306
 Source Schema         : trodb_cloud

 Target Server Type    : MySQL
 Target Server Version : 50732
 File Encoding         : 65001

 Date: 19/08/2021 14:06:52
*/
...
-- ----------------------------
-- Table structure for pt_t_ac_account
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_ac_account`;
CREATE TABLE `pt_t_ac_account` (
...
-- ----------------------------
-- Table structure for pt_t_ac_account_book
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_ac_account_book`;
CREATE TABLE `pt_t_ac_account_book` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='账户账本表';

-- ----------------------------
-- Table structure for pt_t_app_middleware_info
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_app_middleware_info`;
CREATE TABLE `pt_t_app_middleware_info` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for pt_t_application_mnt
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_application_mnt`;
CREATE TABLE `pt_t_application_mnt` (
  `APPLICATION_ID` bigint(19) NOT NULL COMMENT '应用id',
  ...
  `SWITCH_STATUS` varchar(125) DEFAULT NULL,
  PRIMARY KEY (`APPLICATION_ID`) USING BTREE,
  UNIQUE KEY `index_identifier_application_name` (`APPLICATION_NAME`,`USER_ID`) USING BTREE,
...
-- ----------------------------
-- Table structure for pt_t_report
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_report`;
CREATE TABLE `pt_t_report` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for pt_t_return_data
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_return_data`;
CREATE TABLE `pt_t_return_data` (
...
-- ----------------------------
-- Table structure for pt_t_scene_business_activity_ref
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_scene_business_activity_ref`;
CREATE TABLE `pt_t_scene_business_activity_ref` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `scene_id` bigint(20) NOT NULL COMMENT '场景ID',
...
-- ----------------------------
-- Table structure for pt_t_scene_manage
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_scene_manage`;
CREATE TABLE `pt_t_scene_manage` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `custom_id` bigint(20) DEFAULT NULL COMMENT '客户id',
...
-- ----------------------------
-- Table structure for pt_t_scene_script_ref
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_scene_script_ref`;
CREATE TABLE `pt_t_scene_script_ref` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `scene_id` bigint(20) NOT NULL COMMENT '场景ID',
...
-- ----------------------------
-- Table structure for pt_t_scene_sla_ref
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_scene_sla_ref`;
CREATE TABLE `pt_t_scene_sla_ref` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `scene_id` bigint(20) NOT NULL COMMENT '场景ID',
...
-- ----------------------------
-- Table structure for pt_t_tro_user
-- ----------------------------
DROP TABLE IF EXISTS `pt_t_tro_user`;
CREATE TABLE `pt_t_tro_user` (
...
CREATE TABLE `t_ac_account` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `IDX_ACCOUNT_UID` (`uid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8 COMMENT='账户表';
...
) ENGINE=InnoDB AUTO_INCREMENT=64159 DEFAULT CHARSET=utf8 COMMENT='账户账本明细表';
...
CREATE TABLE `t_ac_account_book` (
  ...
  KEY `IDX_ACCOUNT_BOOK_ACC_ID` (`acc_id`) USING BTREE,
  KEY `IDX_ACCOUNT_BOOK_UID` (`uid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8 COMMENT='账户账本表';
...
CREATE TABLE `t_application_ds_manage` (
  ...
  `APPLICATION_ID` bigint(20) DEFAULT NULL COMMENT '应用主键',
  `APPLICATION_NAME` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '应用名称',
  `DS_TYPE` tinyint(2) DEFAULT '0' COMMENT '0:影子库 1:影子表',
...
-- ----------------------------
-- Table structure for t_chaos_app_service
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_app_service`;
CREATE TABLE `t_chaos_app_service` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `app_code` bigint(20) NOT NULL COMMENT '应用code',
  `name` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT '服务名称',
  `path` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '服务地址',
  `service_type` int(1) NOT NULL COMMENT '服务类型 0-HTTP 1-DUBBO 2-MQ 3-JOB',
  `demotion_type` int(1) DEFAULT '0' COMMENT '降级类型 0-自动降级 1-手动降级',
  `demotion_condition` varchar(500) CHARACTER SET utf8 DEFAULT NULL COMMENT '自动降级条件',
  `status` int(1) DEFAULT '0' COMMENT '服务状态',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_code` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT '创建人编码',
  `create_user_name` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT '创建人名称',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `modify_user_code` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT '更新人编码',
  `modify_user_name` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT '更新人名称',
  `is_deleted` int(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `unique_app_service` (`app_code`,`name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='应用服务管理';

-- ----------------------------
-- Table structure for t_chaos_command_plugin
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_command_plugin`;
CREATE TABLE `t_chaos_command_plugin` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `plugin_id` bigint(20) NOT NULL COMMENT '插件ID',
  `plugin_name` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '插件名称',
  `command_id` bigint(20) NOT NULL COMMENT '命令模版ID',
  `command_name` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '命令ID',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='命令模版插件';

-- ----------------------------
-- Table structure for t_chaos_command_template
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_command_template`;
CREATE TABLE `t_chaos_command_template` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '模版命令名',
  `keyword` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '命令关键字',
  `command_template` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '命令模版',
  `param_desc` text CHARACTER SET utf8 COMMENT '参数描述',
  `status` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
  `is_system` tinyint(2) DEFAULT '0' COMMENT '0-系统模版 1-自定义模版',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  `plugin_count` int(10) DEFAULT '0' COMMENT '关联插件数',
  `fault_type` int(10) DEFAULT '1' COMMENT '故障类型(1::JVM故障, 2:CPU故障, 3:网络故障)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='命令模版';

-- ----------------------------
-- Table structure for t_chaos_failure_report
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_failure_report`;
CREATE TABLE `t_chaos_failure_report` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `scene_record_id` bigint(20) NOT NULL COMMENT '场景下发记录ID',
  `scene_record_name` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '场景下发记录名称',
  `command_id` bigint(20) NOT NULL COMMENT '命令ID',
  `plugin_id` bigint(20) NOT NULL COMMENT '插件ID',
  `asw_no` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '阿斯旺场景编号',
  `pressure_count` int(4) DEFAULT NULL COMMENT '压测总数',
  `continuous_time` int(4) DEFAULT NULL COMMENT '持续时间',
  `actual_error_count` int(4) DEFAULT NULL COMMENT '实际异常次数',
  `allow_error_count` int(4) DEFAULT NULL COMMENT '允许异常次数',
  `result_data` text CHARACTER SET utf8 COMMENT '自定义插件，检测结果JSON数据',
  `status` tinyint(2) DEFAULT '0' COMMENT '检测结果 -1-失败 0-未开始 1-检测中 2-通过 3-未通过',
  `message` text CHARACTER SET utf8 COMMENT '检测结果成功或失败信息',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for t_chaos_host
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_host`;
CREATE TABLE `t_chaos_host` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '主机名称',
  `ip` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT 'IP地址',
  `app_code` bigint(20) DEFAULT NULL COMMENT '应用code',
  `app_name` varchar(500) CHARACTER SET utf8 DEFAULT NULL COMMENT '应用名称',
  `port` varchar(10) CHARACTER SET utf8 DEFAULT '0' COMMENT '应用端口',
  `status` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='应用节点管理';

-- ----------------------------
-- Table structure for t_chaos_plugin
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_plugin`;
CREATE TABLE `t_chaos_plugin` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `app_id` bigint(20) DEFAULT '0' COMMENT '所属应用',
  `app_name` varchar(100) CHARACTER SET utf8 DEFAULT '' COMMENT '所属应用名称',
  `plugin_type` int(10) DEFAULT '1' COMMENT '插件类型(1:业务监控,2:故障检测)',
  `plugin_name` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '插件包名称',
  `plugin_package_name` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '插件包名',
  `plugin_package_version` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '插件包版本号',
  `plugin_file` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '插件路径',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `modify_time` datetime NOT NULL COMMENT '更新时间',
  `note` varchar(200) CHARACTER SET utf8 DEFAULT NULL COMMENT '备注',
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除',
  `status` varchar(4) CHARACTER SET utf8 DEFAULT NULL COMMENT '状态(Y=启用, N=禁用)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `unique_app_package_version` (`app_id`,`plugin_package_name`,`plugin_package_version`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='插件信息表';

-- ----------------------------
-- Table structure for t_chaos_scene
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_scene`;
CREATE TABLE `t_chaos_scene` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '场景名称',
  `description` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '场景描述',
  `app_id` bigint(20) NOT NULL COMMENT '应用ID',
  `app_name` varchar(500) CHARACTER SET utf8 NOT NULL COMMENT '应用名称',
  `attach_name` varchar(200) NOT NULL DEFAULT '' COMMENT '应用Attach名称， 查询应用进程唯一匹配字符串',
  `host_count` int(4) NOT NULL COMMENT '主机数量',
  `status` tinyint(2) DEFAULT '0' COMMENT '检测状态 0-未开始 1-检测中 2-检测完毕',
...
-- ----------------------------
-- Table structure for t_chaos_scene_host
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_scene_host`;
CREATE TABLE `t_chaos_scene_host` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `scene_id` bigint(20) NOT NULL COMMENT '场景ID',
  `host_id` bigint(20) NOT NULL COMMENT '场景名称',
  `host_ip` varchar(25) CHARACTER SET utf8 NOT NULL COMMENT '节点IP',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='场景节点配置';

-- ----------------------------
-- Table structure for t_chaos_scene_host_record
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_scene_host_record`;
CREATE TABLE `t_chaos_scene_host_record` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `sence_record_id` bigint(20) NOT NULL COMMENT '场景下发记录ID',
  `sence_rule_id` bigint(20) NOT NULL COMMENT '场景规则ID',
  `host_id` bigint(20) NOT NULL COMMENT '节点ID',
  `host_ip` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT '节点IP',
  `chaos_uid` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '混沌执行成功返回UID，根据UID恢复故障',
  `command` varchar(255) DEFAULT NULL COMMENT '下发命令',
  `command_type` tinyint(2) DEFAULT '0' COMMENT '0-jvm命令、 1-attach命令',
  `restore_time` datetime DEFAULT NULL COMMENT '恢复时间',
  `status` tinyint(2) DEFAULT '0' COMMENT '混沌执行状态 0-执行成功 1-执行失败 2-恢复成功 3-恢复失败',
  `err_msg` text CHARACTER SET utf8 COMMENT '混沌执行失败异常消息',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='场景节点命令分发记录表';

-- ----------------------------
-- Table structure for t_chaos_scene_record
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_scene_record`;
CREATE TABLE `t_chaos_scene_record` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '检测报告名称',
  `scene_id` bigint(20) NOT NULL COMMENT '场景ID',
  `status` tinyint(2) DEFAULT '0' COMMENT '检测状态 0-未开始 1-已暂停 2-进行中 3-混沌执行完成 4-报告生成完成 ',
  `chaos_success_count` int(4) DEFAULT '0' COMMENT '注入成功节点个数',
  `chaos_err_count` int(4) DEFAULT '0' COMMENT '注入失败节点个数',
  `no_expect_count` int(4) DEFAULT '0' COMMENT '不符合预期',
  `err_count` int(4) DEFAULT '0' COMMENT '异常',
  `start_time` datetime DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '结束时间',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='故障检测报表列表';

-- ----------------------------
-- Table structure for t_chaos_scene_rule
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_scene_rule`;
CREATE TABLE `t_chaos_scene_rule` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `scene_id` bigint(20) NOT NULL COMMENT '场景ID',
  `scene_name` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '场景名称',
  `command_id` bigint(20) NOT NULL COMMENT '命令ID',
  `command` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '命令',
  `command_param` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '命令参数',
  `plugin_id` bigint(20) DEFAULT NULL COMMENT '插件ID',
  `plugin_name` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '插件名称',
  `app_service_id` bigint(20) DEFAULT NULL COMMENT '注入服务Id',
  `app_servcie_name` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '注入应用服务',
  `asw_no` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '阿斯旺场景编号',
  `pressure_count` int(4) DEFAULT '0' COMMENT '需要压测总数',
  `continuous_time` int(4) DEFAULT '0' COMMENT '规则持续时间分钟数',
  `allow_error_count` int(4) DEFAULT '0' COMMENT '允许异常次数',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='场景命令配置';

-- ----------------------------
-- Table structure for t_chaos_scene_rule_test_suoyin
-- ----------------------------
DROP TABLE IF EXISTS `t_chaos_scene_rule_test_suoyin`;
CREATE TABLE `t_chaos_scene_rule_test_suoyin` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `scene_id` bigint(20) DEFAULT NULL COMMENT '场景ID',
  `scene_name` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '场景名称',
  `command_id` bigint(20) DEFAULT NULL COMMENT '命令ID',
  `app_servcie_name` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '注入应用服务',
  `asw_no` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '阿斯旺场景编号',
  `pressure_count` int(4) DEFAULT '0' COMMENT '需要压测总数',
  `continuous_time` int(4) DEFAULT '0' COMMENT '规则持续时间分钟数',
...
CREATE TABLE `t_middleware_jar` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_agv` (`agv`(191)) USING BTREE,
...
CREATE TABLE `t_migration_history` (
  ...
  KEY `t_migration_history_s_idx` (`success`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=21438 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `t_report_business_activity_detail` (
  ...
  `gmt_update` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=30093 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `t_scene_business_activity_ref` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_scene_id` (`scene_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4993 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `t_scene_jmeterlog_upload` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_time` datetime DEFAULT NULL COMMENT '修改时间',
  `upload_count` bigint(20) DEFAULT NULL,
  `file_name` varchar(500) DEFAULT NULL COMMENT '文件名',
  PRIMARY KEY (`id`),
  KEY `idx_scene_id_report_id` (`scene_id`,`report_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5199 DEFAULT CHARSET=utf8mb4 COMMENT='压测上传jmeter日志任务状态表';
...
CREATE TABLE `t_scene_script_ref` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_scene_id` (`scene_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3376 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `t_scene_sla_ref` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_scene_id` (`scene_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3836 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `t_schedule_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_scene_id` (`scene_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=21408 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `t_schedule_record_engine_plugins_ref` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='调度记录引擎插件信息';
...
CREATE TABLE `t_tro_user` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `idx_unique_key` (`key`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9768 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
) ENGINE=InnoDB AUTO_INCREMENT=40749 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- 必备数据
BEGIN;
INSERT INTO `pradar_user_login` VALUES (1, 'admin ', 'pradar@123', NULL, 4, 0, NULL, NULL);
INSERT INTO `pradar_user_login` VALUES (2, 'admin12', 'pradar@123', NULL, 4, 0, NULL, NULL);
COMMIT;

BEGIN;
INSERT INTO `t_ac_account_book` VALUES (100, 1, 100, 0, 10000000.00000, 0.00000, 0.00000, NULL, NULL, NULL, 0.00000, NULL, NULL, NULL, NULL, 0, 0, NULL, '2020-07-16 16:20:20.045', '2020-07-16 16:20:20.045');
COMMIT;

BEGIN;
INSERT INTO `t_ac_account` VALUES (100, 1, 0, 0, 0, NULL, '2020-07-16 16:20:19.994', '2020-07-16 16:20:19.994');
COMMIT;
...
BEGIN;
INSERT INTO `t_machine_spec` VALUES (1, '2核8G500G磁盘', 0, '2020-05-12 20:27:58', '2020-05-12 20:27:58');
INSERT INTO `t_machine_spec` VALUES (2, '8核32G500G磁盘', 0, '2020-05-12 20:28:19', '2020-05-12 20:28:19');
INSERT INTO `t_machine_spec` VALUES (3, '16核64G500G磁盘', 0, '2020-05-12 20:28:40', '2020-05-12 20:28:40');
COMMIT;
...
BEGIN;
INSERT INTO `t_tro_user` VALUES (1, 'admin', 'admin', '5b06060a-17cb-4588-bb71-edd7f65035af', '$2a$10$QhtZYezGhYT9kDF72SSWNO', '$2a$10$QhtZYezGhYT9kDF72SSWNO2S/7yCGay4VQT6O.lSGyvAPFAUGDadC', 0, 0, 2, '4.2.3', 0, '2020-03-25 10:49:35', '2020-10-10 15:29:13');
COMMIT;
